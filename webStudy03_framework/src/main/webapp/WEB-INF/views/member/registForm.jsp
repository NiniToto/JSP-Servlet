		...
		<table class="table table-bordered">
			...
			<tr>
				...
				<div class="form-group">
					...
					<span class='error'>${errors.mem_}</span>
				</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<div class="form-group">
					...
					<span class='error'>${errors.mem_hometel1}</span>
				</div>
				</td>
			</tr>
			<tr>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/searchZip.js"></script>
<script type="text/javascript">
