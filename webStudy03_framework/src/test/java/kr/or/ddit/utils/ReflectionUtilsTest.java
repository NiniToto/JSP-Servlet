...
public class ReflectionUtilsTest {
	...
	public void testGetMethodsWithAnnotationAtClass() {
		Map<Method, Annotation> methods = ReflectionUtils.getMethodsWithAnnotationAtClass(MemberControllerPsedo.class, URIMapping.class, String.class, HttpServletRequest.class, HttpServletResponse.class);
